...
[![Tests](https://github.com/step-security/xcodebuild-action/actions/workflows/tests.yml/badge.svg)](https://github.com/step-security/xcodebuild-action/actions/workflows/tests.yml)
...
```yaml
uses: step-security/xcodebuild-action@v4
with:
  spm-package: './'
